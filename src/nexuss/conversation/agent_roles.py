...
ROLES = (
    ...
    AgentRole("Maintenance", "Health monitoring and diagnostics", "tas.investigation.health", "diagnostics and opt-in managed bridge reconnection available; TAS repairs pending"),
